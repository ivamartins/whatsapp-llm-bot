...
name: whatsapp-reply
description: >
  Craft natural, context-aware replies for WhatsApp messages. Load this skill
  whenever the bot forwards an incoming message for reply suggestion. Always
  consider tone, brevity, and when it is better NOT to reply.
version: 1.0.0
